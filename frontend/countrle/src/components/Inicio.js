    ...
    <div>
      ...
      <div class="container animacion-carga">
        <div class="jumbotron">
          ...
          <br></br>
          <p class="lead">Countrle es una emocionante juego en la que podrás poner a prueba tus conocimientos sobre países y adivinar palabras relacionadas con ellos. ¿Estás listo para desafiar tu mente y ampliar tus horizontes geográficos? </p>
          ...
          <div class="container marketing">
            ...
            <div class="row featurette">
              <div class="col-md-7">
                <h2 class="featurette-heading text-center">Amplía tus horizontes geográficos <span class="text-muted">con Countrle.</span></h2>
                <p class="lead">
              ...
              <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" src={iphone_mockup} alt="Captura de pantalla de Countrle en un iPhone"></img>
              </div>
            </div>
            ...
            <div class="row featurette">
              <div class="col-md-7 order-md-2">
                <h2 class="featurette-heading text-center">Aprende mientras te diviertes <span class="text-muted">y reta a tus amigos.</span></h2>
                <p class="lead">
              ...
              <div class="col-md-5 order-md-1">
                <img class="featurette-image img-fluid mx-auto" src={trofeo} alt="Trofeo y birrete"></img>
              </div>
            </div>
            ...
            <div class="row featurette">
              <div class="col-md-7 order-md-2">
                <h2 class="featurette-heading text-center">Juega a Countrle <span class="text-muted">desde cualquier lugar.</span></h2>
                <p class="lead">
              ...
              <div class="col-md-5 order-md-2">
                <img class="featurette-image img-fluid mx-auto" src={captura_pwa} alt="Captura de Countrle instalada en un iPhone"></img>
              </div>
            </div>
            <br /><br />
            <p class="aviso">*Las PWA requieren de un dispositivo iOS 11.3, Android 5.0 (Lollipop) o superior y Chrome, Firefox, Safari y Edge actualizados para sistemas de escritorio. </p>
